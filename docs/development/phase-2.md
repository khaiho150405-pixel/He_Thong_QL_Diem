...
Phần 1–2 backend và phần 3 Flutter đã hoàn tất, [CI toàn Phase 2 xanh](https://github.com/khaiho150405-pixel/He_Thong_QL_Diem/actions/runs/34565168338); đang chờ review trước khi merge. Nền là Phase 1 commit `2b124de`; phần 1 commit `0ae7fbc`, phần 2 commit `3ad0865`, phần 3 commit `23df8fe` và ổn định CI commit `887155c`. Giữ nhánh `codex/phase-2-part-1-gradebooks`; không tự merge main.
