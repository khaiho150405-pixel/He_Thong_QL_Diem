...
Cập nhật: 2026-09-08. Bản mã `307e7f1` đã có [CI xanh toàn bộ](https://github.com/khaiho150405-pixel/He_Thong_QL_Diem/actions/runs/34197522112). Giai đoạn 0 vẫn còn điều kiện cộng tác chưa hoàn tất.
...
| Smoke phục hồi native | Lỗi → Thử lại → API thật thành công đã pass trên Android và iOS, CI commit 307e7f1; Web được kiểm trực tiếp                                     |
...
1. Cung cấp reviewer thật, [mở draft PR](https://github.com/khaiho150405-pixel/He_Thong_QL_Diem/compare/main...feat/phase-0-foundation?expand=1), bật bảo vệ main và xác minh review policy.
2. Đồng nghiệp clone/setup trên máy riêng và ghi bằng chứng onboarding; chốt license.
