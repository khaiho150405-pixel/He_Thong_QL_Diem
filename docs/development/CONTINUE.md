...
- Yêu cầu mới nhất: tiếp tục build dự án; Phase 3 phần 4 đã hoàn tất local, bước kế tiếp là Phase 4 đối chiếu UC13 mà chưa cần file trọng số OCR.
...
4. Bắt đầu Phase 4 UC13 theo lát dọc: contract quyết định từng dòng, kiểm mọi dòng bắt buộc xem, version/idempotency, transaction duyệt nguyên tử, rồi UI đối chiếu keyboard-friendly. Chưa nối model thật khi chưa có weights.
