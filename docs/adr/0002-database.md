...
API runtime phase 0 được đọc 16 bảng, INSERT lịch sử và gọi validator; không có ghi điểm/danh mục khi chưa có use case kiểm quyền. Migration role sở hữu schema; runtime không có DDL. Phân quyền ghi được thêm bằng migration cùng các UC, không cấp toàn bộ DML mặc định.
