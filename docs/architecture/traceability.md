...
| UC09    | gradebooks/bang_diem, diem_thanh_phan             | Phase 2 phần 1: service tạo lưới NULL/đọc cursor, quyền phân công, audit tạo bảng, migration hàm giới hạn; integration/gradebooks.test.ts. Chưa có API nhập/chốt hoặc UI |
| UC10    | audit/lich_su_sua_diem                            | Append-only baseline giữ nguyên; API lịch sử và transaction sửa điểm thuộc Phase 2 phần 2                                                                                |
