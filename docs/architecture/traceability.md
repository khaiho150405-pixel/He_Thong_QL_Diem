...
| UC11–12 | recognition/files                                 | Upload multipart + private object + phiếu/audit/idempotency/outbox nguyên tử và BullMQ dispatcher đã có; worker/FastAPI/lưu dòng còn lại |
