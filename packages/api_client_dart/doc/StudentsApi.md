# api_client_dart.api.StudentsApi
...
# **studentsCreate**
> StudentsDto studentsCreate(studentsInput)
...
final StudentsInput studentsInput = ; // StudentsInput |

try {
    final response = api.studentsCreate(studentsInput);
    print(response);
} catch on DioException (e) {
    print('Exception when calling StudentsApi->studentsCreate: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **studentsInput** | [**StudentsInput**](StudentsInput.md)|  |
...
# **studentsList**
> StudentsPage studentsList(q, cursor)
...
try {
    final response = api.studentsList(q, cursor);
    print(response);
} catch on DioException (e) {
    print('Exception when calling StudentsApi->studentsList: $e\n');
}
```
...
try {
    api.studentsRemove(id);
} catch on DioException (e) {
    print('Exception when calling StudentsApi->studentsRemove: $e\n');
}
```
...
# **studentsUpdate**
> StudentsDto studentsUpdate(id, studentsInput)
...
try {
    final response = api.studentsUpdate(id, studentsInput);
    print(response);
} catch on DioException (e) {
